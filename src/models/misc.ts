...
const reminderSchema = new mongoose.Schema(
  {
    ...
    kind: { type: String, enum: ['manual', 'auto'] as const, default: 'manual', required: true },
...
const supportTicketSchema = new mongoose.Schema(
  {
    kind: { type: String, enum: ['cycle_resolution', 'reconciliation', 'payout', 'general'] as const, required: true },
    status: { type: String, enum: ['open', 'resolved'] as const, default: 'open', required: true },
    userId: { type: ObjectId, ref: 'User', required: true },
    groupId: { type: ObjectId, ref: 'Group' },
    cycleId: { type: ObjectId, ref: 'Cycle' },
...
const otpSchema = new mongoose.Schema(
  {
    ...
    purpose: { type: String, enum: ['signup', 'reset_password'] as const, required: true },
...
const webhookEventSchema = new mongoose.Schema(
  {
    ...
    status: { type: String, enum: ['received', 'processed', 'ignored', 'error'] as const, default: 'received', required: true },
    error: String,
  },
  { timestamps: true },
);
...
export type SupportTicketKind = 'cycle_resolution' | 'reconciliation' | 'payout' | 'general';
