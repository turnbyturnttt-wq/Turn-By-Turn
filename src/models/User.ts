...
export const USER_STATUSES = ['pending_verification', 'pending_password', 'active', 'suspended'] as const;
...
export type NotificationPreferenceKey =
  | 'push' | 'email' | 'sms' | 'paymentReminders' | 'groupActivity' | 'announcements' | 'payoutUpdates';
...
const userSchema = new mongoose.Schema(
  {
    ...
    status: { type: String, enum: USER_STATUSES, default: 'pending_verification' as UserStatus, required: true },
  ...
  },
  {
    ...
    virtuals: {
      profilePhotoUrl: {
        get(this: { profilePhotoFileId?: mongoose.Types.ObjectId | null }): string | null {
